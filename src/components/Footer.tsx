...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-slate-950/90 px-6 py-20 text-slate-300 backdrop-blur-xl sm:px-8">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
        <div className="space-y-6">
          <div className="flex items-center gap-3 text-white">
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-3xl bg-gradient-to-br from-cyan-400/20 to-violet-500/15 text-cyan-300 ring-1 ring-cyan-300/20">Z</div>
            <div>
              <p className="text-lg font-semibold text-white">Zyglo Tech Enterprise</p>
              <p className="text-sm text-slate-400">Move fast. Build smart. Scale bold.</p>
            </div>
          </div>
          <p className="max-w-xl text-sm leading-6 text-slate-400">
            An AI-first SaaS platform for Chennai businesses, enterprise automation, and future-ready training experiences.
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5">
              ...
              <p className="text-sm text-slate-300">+91 90000 00000</p>
            </div>
            <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5">
              <p className="text-sm uppercase tracking-[0.3em] text-cyan-300">Location</p>
              <p className="mt-3 text-sm text-slate-300">Chennai, Tamil Nadu, India</p>
            </div>
          </div>
        </div>
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-cyan-300">Stay connected</p>
            ...
            <div className="mt-6 rounded-[1.75rem] bg-slate-900/80 p-4 text-sm text-slate-400">
